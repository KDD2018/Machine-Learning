...
class Processing():
    ...
    def get_category(self, car_class, car_system, car_level):
        ...
        '''
        # 分类型特征名称
        cols_name_categ_NEV = ['car_system', 'level','displacement', 'driving',
                               'maximum_power', 'register_time', 'sell_times', 'model_year'] #  'gearbox_type','intake_form',
        cols_name_categ_EV = ['car_system', 'driving',  'maximum_power', 'register_time',
                             'sell_times', 'model_year', 'voyage_range'] # 'gearbox_type',
        # 分类型特征类别
        ...
        categories_EV = [driving, maximum_power, register_time, sell_times, model_year,
                         voyage_range]
